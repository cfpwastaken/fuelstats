	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				warning: "bg-amber-300/10 [a]:hover:bg-amber-300/20 focus-visible:ring-amber-300/20 dark:focus-visible:ring-amber-300/40 text-amber-foreground dark:bg-amber-300/20",
